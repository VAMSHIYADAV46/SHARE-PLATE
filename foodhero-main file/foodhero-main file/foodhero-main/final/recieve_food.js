        ...
        if (filteredResults.length > 0) {
            filteredResults.forEach(result => {
                ...
                marker.on('click', function (){
                    window.location.href = 'of.html?param1=' + encodeURIComponent(result.Food_Name) + '&param2=' + encodeURIComponent(result.Quantity)+'&param3=' + encodeURIComponent(result.Fresh_Time)+'&param4=' + encodeURIComponent(result.Location)+'&param5=' + encodeURIComponent(result.Mobile_Number)+
